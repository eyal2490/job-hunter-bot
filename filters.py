...
1. Title or description MUST contain an EE field indicator (hardware/FPGA/etc.)
   Plus negative checks for seniority, PhD-only, years of experience, etc.
   Plus location exclusions (e.g. Haifa - too far for SIL).
   “””
...
“”“Return True if the location is in the exclusion list (e.g. Haifa).”””
loc = _norm(location_text)
if not loc:
return False
